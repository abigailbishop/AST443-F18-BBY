...
# Open Files
dark_f_0 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000017.DARK.FIT')
dark_0 = dark_f_0[0].data
dark_f_1 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000018.DARK.FIT')
dark_1 = dark_f_1[0].data
dark_f_2 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000019.DARK.FIT')
dark_2 = dark_f_2[0].data
dark_f_3 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000020.DARK.FIT')
dark_3 = dark_f_3[0].data
dark_f_4 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000021.DARK.FIT')
dark_4 = dark_f_4[0].data
dark_f_5 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000022.DARK.FIT')
dark_5 = dark_f_5[0].data
dark_f_6 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000023.DARK.FIT')
dark_6 = dark_f_6[0].data
dark_f_7 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000024.DARK.FIT')
dark_7 = dark_f_7[0].data
dark_f_8 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000025.DARK.FIT')
dark_8 = dark_f_8[0].data
dark_f_9 = fits.open('3.1_p10_DARK_1minexpo/3.1_p10.00000026.DARK.FIT')
...
bias_master = fits.open('pos10BIAS_master.fits')
...
ax.text(0.65, 0.95, textstr, transform=ax.transAxes, fontsize=14,
    verticalalignment='top', bbox=props)
plt.savefig('pos10DARK_adjusted.pdf', ppi=300)
hot_column = []
hot_row = []
...
ax.text(0.06, 0.95, textstr, transform=ax.transAxes, fontsize=14,
    verticalalignment='top', bbox=props)
plt.savefig('pos10DARK_typical-exposure.pdf', ppi=300)
plt.clf()
